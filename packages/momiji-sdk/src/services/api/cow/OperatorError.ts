...
export default class OperatorError extends MomijiError {
	...
	public constructor(apiError: ApiErrorObject) {
	...
	public static apiErrorDetails = ApiErrorCodeDetails;
	...
	public static async getErrorFromStatusCode(response: Response, action: 'create' | 'delete') {
		switch (response.status) {
			...
			default:
				log.error(
					logPrefix,
					`[OperatorError::getErrorFromStatusCode] Error ${action === 'create' ? 'creating' : 'cancelling'} the order, status code:`,
