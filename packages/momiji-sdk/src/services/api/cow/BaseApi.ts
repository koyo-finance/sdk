...
import { CowError, Options, SupportedChainId } from '@cowprotocol/cow-sdk';
...
export class BaseApi {
	...
	public constructor({ context, name, getApiUrl, defaultHeaders = DEFAULT_HEADERS, apiVersion = DEFAULT_API_VERSION }: ConstructorParams) {
