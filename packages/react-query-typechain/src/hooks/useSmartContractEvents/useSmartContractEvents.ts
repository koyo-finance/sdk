...
export function useSmartContractEvents<TContract extends Contract, TFilterName extends ContractFilterName<TContract>>(
	contract: TContract | undefined,
	filterName: TFilterName,
	options?: UseSmartContractEventsCallOptions<TContract, TFilterName>
): QueryObserverResult<Event[]> {
	const queryOptions = makeSmartContractEventsUseQueryOptions<TContract, TFilterName>(contract, filterName, options);
...
export function makeSmartContractEventsUseQueryOptions<TContract extends Contract, TFilterName extends ContractFilterName<TContract>>(
	contract: TContract | undefined,
	filterName: TFilterName,
	options?: UseSmartContractEventsCallOptions<TContract, TFilterName>
	...
	const queryKey = makeSmartContractEventsQueryKey<TContract, TFilterName>(contract, filterName, callArgs, fromBlock, toBlock);
	...
	return {
		...
		queryFn,
		onError: () => {
			console.error(`Error calling ${filterName as string} on: ${contract?.address} with arguments:`, callArgs);
		},
...
export function makeSmartContractEventsQueryKey<TContract extends Contract, TFilterName extends ContractFilterName<TContract>>(
	contract: TContract | undefined,
	filterName: TFilterName,
	callArgs: Parameters<TContract['filters'][TFilterName]> | undefined,
	fromBlock?: number,
	toBlock?: number
): [string, TFilterName, string | undefined, number | undefined, number | undefined, Parameters<TContract['filters'][TFilterName]> | undefined] {
